    ...
    <body>
        ...
        <div id="home">
            <blockquote>
                    ...
                    ArrayList<AppliedVacancyDto> list = applied.getCandidateVacancyList(email);
                %>
                <h2 style="font-family: candara;">Welcome <%=email%> | Vacancy Status</h2>
